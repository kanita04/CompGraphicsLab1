...
# Step 5: Draw the entrance gable (triangle)
...
# Step 6: Draw the door (arch + rectangle)
...
# Step 7: Draw the circular window above the door
context.arc(300, 240, 15, 0, 2 * 3.14159)  # Draw the circle at (300, 240) with radius=15
context.fill()

# Step 8: Draw the windows on the left wing
...
print("Drawing completed and saved as chapel_drawing.png")
